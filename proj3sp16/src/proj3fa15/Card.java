...
public class Card
{
	...
	/**
	 * createJoker method --
	 * Static method that is responsible for creating and returning a joker which is ranked
	 * higher than any of the other cards(value=14) and has Joker stored as its suit
	 * @return Card reference of a Joker
	 */
